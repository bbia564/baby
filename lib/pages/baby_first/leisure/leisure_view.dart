...
class LeisurePage extends GetView<LeisureLogic> {
  @override
                      ...
                      Expanded(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                              ...
                              .gestures(onTap: () {
                                Get.toNamed('/leisureDetails',arguments: 'Tummy Time')?.then((_) {
                                  controller.getData();
                                });
                          })),
                      const SizedBox(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                              ...
                              .decorated(
                                  ...
                                  borderRadius: BorderRadius.circular(12))
                              .gestures(onTap: () {
                            Get.toNamed('/leisureDetails',arguments: 'Bath Time')?.then((_) {
                              controller.getData();
                            });
                          }))
                    ].toRow(),
                      ...
                      Expanded(
                          child: Container(
                            ...
                            child: const Text(
                              ...
                              borderRadius: BorderRadius.circular(12))
                              .gestures(onTap: () {
                            Get.toNamed('/leisureDetails',arguments: 'Play Time')?.then((_) {
                              controller.getData();
                            });
                          })),
                      const SizedBox(
                      ...
                      Expanded(
                          child: Container(
                            ...
                            child: const Text(
                              ...
                              borderRadius: BorderRadius.circular(12))
                              .gestures(onTap: () {
                            Get.toNamed('/leisureDetails',arguments: 'Outdoors')?.then((_) {
                              controller.getData();
                            });
                          }))
                    ].toRow()
