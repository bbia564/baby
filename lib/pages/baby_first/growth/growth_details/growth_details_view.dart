...
class GrowthDetailsPage extends GetView<GrowthDetailsLogic> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: <Widget>[
                    ...
                    Obx(() {
                      return Text(
                        controller.valueNum.value.toString(),
                    ...
                    Obx(() {
                      return Slider(
                          value: controller.valueNum.value.toDouble(),
                          min: 0,
                          max: 300,
                          activeColor: itemBGColors[4],
                          inactiveColor: Colors.grey[200],
                          onChanged: (value) {
                            controller.valueNum.value = value.toInt();
