...
class SleepPage extends GetView<SleepLogic> {
  @override
                ...
                Container(
                  ...
                  child: <Widget>[
                    ...
                    Container(
                      ...
                      child: GetBuilder<SleepLogic>(builder: (_) {
                        return Text(
                        ...
                        return <Widget>[
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 20,color: itemBGColors[entity.type]),
                            ),
                          ).decorated(
                              color: itemColors[controller.type],
